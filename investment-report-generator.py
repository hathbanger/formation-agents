...
if __name__ == "__main__":
    ...
    if os.getenv("RUN_AS_API", "0") == "1":
        ...
        def workflow_runner(companies):
            ...
            result = generator.run(companies=companies)
